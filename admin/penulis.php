            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Silahkan kelola penulis</li>
                    </ol>
                    <div class="card mb-4">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-warning" name="btn_ubah_penulis" data-bs-toggle="modal" data-bs-target="#modalFormUpdatePenulis<?php echo $data_id_penulis; ?>">Ubah</button>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="POST">
                                                            <div class="modal-body mb-3">
                                                                Apakah Penulis dengan nama: <?php echo "<b>" . $data_nama . "</b>"; ?> akan dihapus?
